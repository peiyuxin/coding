...
public class ForkJoinTest extends RecursiveTask<Long> {
    ...
    //计算和 use computeSequentially
    @Deprecated
    private long computeSequentiallyDep() {
    ...
    public static void main(String[] args) {
        long[] numbers = new long[]{1,2,8,9,9999,444,559,5353,9090};
        ForkJoinTest ft = new ForkJoinTest(numbers,2,4);
        ft = new ForkJoinTest(numbers,0,numbers.length);
        System.out.println(ft.computeSequentially());
        System.out.println(ft.computeSequentiallyDep());

        ////////////
        numbers = LongStream.rangeClosed(1, 1000*10000).toArray();

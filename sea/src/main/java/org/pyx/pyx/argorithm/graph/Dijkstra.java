...
class Graph {
    ...
    public void dijkstra(String startName) {
        ...
        //贪婪算法的本质,每次都认为是最优解,先放进去的也是最近的最短的路径
    ...
    private void dijkstraDealQueue(final PriorityQueue<Vertex> q) {
        Vertex u,v;
        while (!q.isEmpty()){
            ...
            if (u.dist == Integer.MAX_VALUE) {
                // 对于连通的图不会走到这一步
                break;// we can ignore u (and and other remaining vertices) since they are unreachable
            }
    ...
    /**
     * print the path from the source to every vertex (output order is not guaranteed)
     */
